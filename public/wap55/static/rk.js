function convertDate(val, withWeek) {
        ...
        kLine.prototype = {
            ...
            paintItems: function () {
                ...
                xScalers.push(convertDate(filteredData[0].quoteTime, false).substr(3));
        ...
        var painter = this.canvasKL.painter;// = new Painter('canvasKL', kl, data);
        var initialWidth = Math.min(screen.width,414)-40;
