	function line(ctx, x0, y0, x1, y1, color, width) {
            ...
            show: function (relativePoint, html) {
                ...
                if (dc) {
                    if (dc.isNewQuote) painter.fillTopText(dc.data);
                    	...
                    	painter.fillTopText(dc.data, dc.index);}
                }
            },
            ...
            */
            ...
            paintChart: function (data) {
                ...
                addCrossLinesAndTipEvents(this.canvas, {
                    ...
                    triggerEventRanges: { x: chartRegion.x, y: chartRegion.y, width: chartRegion.width*0.89, height: (me.volume.region.y + me.volume.region.height - chartRegion.y)*0.9 },
                    tipOptions: {
            ...
            fillTopText: function (data, minIndex) {
                ...
                var txtRiseFall = (isRise ? '↑' : (isFall ? '↓' : '')) + diff + ('(') + toMoney(diff * 100 / quote.preClose) + '%)';
                ...
                var txtTime = temp.charAt(0) + temp.charAt(1) + ':' + temp.charAt(2) + temp.charAt(3);
                ctx.fillStyle = topText.color;
        ...
        var chart = new minsChart('canvas', {
            ...
            minsChart: {
                ...
                horizontalLineCount: 7, verticalLineCount: 3,priceLinewidth:'#90b7de',
